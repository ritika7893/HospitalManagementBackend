...
from .views import AllRegistrationAPIView, AppointmentAPIView, ChangePasswordAPIView, CreateProfileAPIView, DepartmentListAPIView, LoginAPIView, RefreshTokenAPIView, UserDetailAPIView
urlpatterns=[
