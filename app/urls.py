...
from .views import AllRegistrationAPIView, ChangePasswordAPIView, CreateProfileAPIView, DepartmentListAPIView, LoginAPIView, RefreshTokenAPIView, UserDetailAPIView
urlpatterns=[
